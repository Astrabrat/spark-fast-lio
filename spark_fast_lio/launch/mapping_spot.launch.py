...
def generate_launch_description():
    ...
    default_config = os.path.join(pkg_share, 'config', 'spot.yaml')
    default_rviz = os.path.join(pkg_share, 'rviz', 'spot.rviz')

    return LaunchDescription([
        DeclareLaunchArgument('namespace', default_value='spot',
